        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              By accessing or using TrueBond, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our platform. TrueBond is designed for individuals seeking meaningful, genuine connections.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              You must be at least 18 years old to use TrueBond. By using our service, you represent and warrant that you meet this age requirement and have the legal capacity to enter into these terms.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              To use TrueBond, you must create an account with accurate and complete information. You are responsible for:
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              TrueBond uses a coin-based messaging system:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              TrueBond is built on trust and respect. Users must not:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              TrueBond and its content, features, and functionality are owned by TrueBond and protected by intellectual property laws. You retain ownership of content you post but grant us a license to use it for operating the service.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              TrueBond is provided "as is" without warranties. We are not liable for any indirect, incidental, or consequential damages arising from your use of the platform. We do not guarantee matches or relationship outcomes.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              We may update these terms from time to time. We will notify users of significant changes. Continued use of TrueBond after changes constitutes acceptance of the new terms.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              <br /><br />
              <strong>Email:</strong> legal@truebond.com<br />
              <strong>Support:</strong> support@truebond.com
            </p>
          </section>
        </div>
      </div>
